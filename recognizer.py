...
EMBEDDINGS_PATH = "./fr_embeddings.pkl"
...
DATASET_PATH = "./dataset" # Path to the dataset for verification
WEBCAM_INDEX = 0 # 0 for default webcam, change if you have multiple

# Recognition & Verification
VERIFICATION_COUNT = 5 # How many images from dataset to check for verification
THRESHOLD = 0.45 # Distance threshold for matching

# Liveness Detection
LIVENESS_ENABLED = True # Set to False to disable liveness check
LIVENESS_BUFFER_SIZE = 7 # Number of frames to store for liveness check
